...
public class HelloWorld {
    public static void main(String[] args)
    {
        ...
        {
            Punkt p1 = new Punkt(5, 5);
            Transformacja tr2 = new ZlozenieTransformacji(new Transformacja[]{new Skalowanie(2,5), new Translacja(3,4), new Translacja(3,4)});
            System.out.println(p1);
            Punkt p2 = tr2.transformuj(p1);
            System.out.println(p2);
            Transformacja trr2 = tr2.getTransformacjaOdwrotna();
        ...
        /*
        Punkt first = new Punkt(1,5);
        System.out.println("Pobieranie współrzędnych:");
        System.out.println("x " + first.getX() + " y " + first.getY());
        System.out.println("Drukowanie całego obiektu:");
        System.out.println(first);
        Punkt second = new Punkt(10,51);

        System.out.println("Porównywanie referencji: first == first");
        System.out.println(first == first);
        System.out.println("Porównywanie referencji: first == second");
        System.out.println(first == second);
        System.out.println("Metoda equals: first.equals(first)");
        System.out.println(first.equals(second));
        System.out.println("Metoda equals: first.equals(second)");
        System.out.println(first.equals(second));

        System.out.println("Metoda hashCode: first.hashCode()");
        System.out.println(first.hashCode());
        System.out.println("Metoda hashCode: second.hashCode()");
